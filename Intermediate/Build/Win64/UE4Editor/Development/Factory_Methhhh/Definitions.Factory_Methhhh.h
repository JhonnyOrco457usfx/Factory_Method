...
#define UE_PROJECT_NAME Factory_Methhhh
#define UE_TARGET_NAME Factory_MethhhhEditor
#define UE_MODULE_NAME "Factory_Methhhh"
...
#define FACTORY_METHHHH_API DLLEXPORT
